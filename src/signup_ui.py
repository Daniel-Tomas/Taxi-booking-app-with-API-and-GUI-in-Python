...
class Ui_signup_dialog(object):
    def setupUi(self, signup_dialog):
        ...
        self.signup_frame.setGeometry(QtCore.QRect(190, 130, 381, 361))
        ...
        self.name_lineEdit = QtWidgets.QLineEdit(self.signup_frame)
        self.name_lineEdit.setGeometry(QtCore.QRect(170, 120, 171, 20))
        self.name_lineEdit.setObjectName("name_lineEdit")
        self.email_lineEdit = QtWidgets.QLineEdit(self.signup_frame)
        self.email_lineEdit.setGeometry(QtCore.QRect(170, 160, 171, 20))
        self.email_lineEdit.setObjectName("email_lineEdit")
        self.name_label = QtWidgets.QLabel(self.signup_frame)
        self.name_label.setGeometry(QtCore.QRect(60, 120, 81, 21))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.name_label.setFont(font)
        self.name_label.setObjectName("name_label")
        self.email_label = QtWidgets.QLabel(self.signup_frame)
        self.email_label.setGeometry(QtCore.QRect(60, 160, 81, 21))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.email_label.setFont(font)
        self.email_label.setObjectName("email_label")
        self.signup_button = QtWidgets.QPushButton(self.signup_frame)
        self.signup_button.setGeometry(QtCore.QRect(150, 300, 71, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.signup_button.setFont(font)
        self.signup_button.setObjectName("signup_button")
        self.phone_label = QtWidgets.QLabel(self.signup_frame)
        self.phone_label.setGeometry(QtCore.QRect(60, 200, 101, 21))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.phone_label.setFont(font)
        self.phone_label.setObjectName("phone_label")
        self.phone_lineEdit = QtWidgets.QLineEdit(self.signup_frame)
        self.phone_lineEdit.setGeometry(QtCore.QRect(170, 200, 171, 20))
    ...
    def retranslateUi(self, signup_dialog):
        ...
        self.name_lineEdit.setPlaceholderText(_translate("signup_dialog", "Please enter your name"))
        self.email_lineEdit.setPlaceholderText(_translate("signup_dialog", "Please enter your email"))
        self.name_label.setText(_translate("signup_dialog", "Name"))
